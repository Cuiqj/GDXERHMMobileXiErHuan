...
-(void)formCloseReason{
    ...
    NSString *stationStartMString=[[AppConstants numberFormatter] stringFromNumber:@(self.textStartM.text.integerValue)];
    NSString *stationString;
    if (self.textEndM.text.integerValue == 0 && self.textEndKM.text.integerValue==0  ) {
        ...
        NSString *stationEndMString=[[AppConstants numberFormatter] stringFromNumber:@(self.textEndM.text.integerValue)];
