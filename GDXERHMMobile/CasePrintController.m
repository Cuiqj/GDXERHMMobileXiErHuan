...
- (BOOL)saveAsPDF:(NSString *)path dataOnly:(BOOL)isDataOnly
{
    if ([self.delegate respondsToSelector:@selector(templateNameKey)]) {
        ...
        //template=[GRMustacheTemplate templateFromContentsOfFile:[NSString stringWithFormat:@"/Users/admin/项目/GDXERHMMobileXiErHuan/GDXERHMMobile/DocTemplates/%@.xml.mustache", templateNameKey] error:&err];
