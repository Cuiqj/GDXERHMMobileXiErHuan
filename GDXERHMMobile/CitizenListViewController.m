        ...
        for (int i=0; i<self.citizenList.count; i++) {
            ...
            for (UITextField *textField in myCell.contentView.subviews) {
                if ([textField isKindOfClass:[UITextField class]]) {
                    ...
                    NSPredicate *deformPredicate=[NSPredicate predicateWithFormat:@"proveinfo_id ==%@ && citizen_name==%@",_caseID,autoNumberOriginal];
                    ...
                    for (CaseDeformation *deform in deformArray){
                        deform.citizen_name = citizen.automobile_number;
                    }
