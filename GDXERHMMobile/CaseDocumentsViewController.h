...
@interface CaseDocumentsViewController : UIViewController<UIPrintInteractionControllerDelegate,UINavigationControllerDelegate,UIWebViewDelegate,UITextFieldDelegate,UITextViewDelegate> {
    CGPoint svos;
}
